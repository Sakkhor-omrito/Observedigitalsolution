                    ...
                    <div className="row heros_row">
                        <div data-aos="fade-right" className="col-lg-7 m-0 p-0 ">
                            <div className="hero_left">
                                ...
                                <p>Welcome To
                                    Observe Digital Solution. Observe Digital Solution is a Professional software and website agency Platform. Here we will provide you only interesting content, which you will like very much. Were dedicated to providing you the best of software and website agency. </p>
                            </div>
                        </div>
